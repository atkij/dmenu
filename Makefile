...
dist: clean
	...
	cp LICENSE Makefile README arg.h config.def.h config.mk dmenu.1\
		drw.h util.h dmenu_path dmenu_run dmenu_run_history passmenu passmenu2 stest.1 $(SRC)\
		dmenu-$(VERSION)
...
install: all
	...
	cp -f dmenu dmenu_path dmenu_run dmenu_run_history passmenu passmenu2 stest $(DESTDIR)$(PREFIX)/bin
